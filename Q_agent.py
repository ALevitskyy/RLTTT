...
class Qagent:
    def constant_factory(self):
        ...
        return 0.9
    def __init__(self,dimension1,dimension2,order, Q={}, alpha=0.3, gamma=0.9,epsilon=0.1):
        self.Q=Q
        self.alpha=alpha
        self.gamma=gamma
        ...
        self.order=order
        self.action=[]
        self.Qpath=os.path.join("saved_agents","Qagent-"+str(self.dimension1)+
    ...
    def update_endog(self, s, s_, a, r):
        ...
        if r==0:
            ...
            try:
                ...
                the_update=0
            self.Q[tuple(a)][s] = (1 - self.alpha)*self.Q[tuple(a)][s] + self.alpha*(r -
                  self.gamma*the_update)
        else:
            #if endstate. 
            self.Q[tuple(a)][s] = (1 - self.alpha)*self.Q[tuple(a)][s] + self.alpha*(r)
